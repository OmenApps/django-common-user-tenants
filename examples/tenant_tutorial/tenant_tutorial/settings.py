...
DATABASES = {
    'default': {
        'ENGINE': 'django_common_user_tenants.postgresql_backend',  # Add 'postgresql', 'mysql', 'sqlite3' or 'oracle'.
...
DATABASE_ROUTERS = (
    'django_common_user_tenants.routers.TenantSyncRouter',
)
...
SHARED_APPS = (
    'django_common_user_tenants',  # mandatory
...
DEFAULT_FILE_STORAGE = "django_common_user_tenants.files.storage.TenantFileSystemStorage"
